// api/pkg/signing/imgurl_test.go
...
func TestPublicImageURL_NoSig(t *testing.T) {
	b := signing.NewURLBuilder("https://cdn.example.com", testKey, func() time.Time { return time.Unix(1700000000, 0) })
...
func TestPrivateImageURL_RejectsPublicKey(t *testing.T) {
	b := signing.NewURLBuilder("https://cdn.example.com", testKey, time.Now)
